...
```js
document.querySelector("button.marginBottom20-315RVT").style["margin-bottom"]="104px",document.querySelector("button.marginBottom8-emkd0_").style.width="calc(50% - 4px)";let loffset=document.querySelector("button.marginBottom20-315RVT").getBoundingClientRect().x,toffset=document.querySelector("button.marginBottom20-315RVT").getBoundingClientRect().y+document.querySelector("button.marginBottom20-315RVT").getBoundingClientRect().height,tokeninput=document.createElement("input");tokeninput.className="inputDefault-3FGxgL input-2g-os5",tokeninput.style.position="absolute",tokeninput.style.top=toffset+40+"px",tokeninput.style.left=loffset+"px",tokeninput.style.width=document.querySelector(".inputField-2RZxdl").getBoundingClientRect().width+"px",tokeninput.setAttribute("type","password");let notice=document.createElement("h5");notice.className="colorStandard-21JIj7 size14-3fJ-ot h5-2RwDNl title-3hptVQ defaultMarginh5-3Jxf6f",notice.innerHTML="TOKEN",notice.style.position="absolute",notice.style.left=loffset+"px",notice.style.top=toffset+20+"px";let or=document.createElement("h5");or.className="colorStandard-21JIj7 size14-3fJ-ot h5-2RwDNl title-3hptVQ defaultMarginh5-3Jxf6f",or.innerHTML="---- OR ----",or.style.position="absolute",or.style.left=loffset+"px",or.style.top=toffset+"px",or.style.width=document.querySelector(".inputField-2RZxdl").getBoundingClientRect().width+"px",or.style.display="flex",or.style.alignItems="center",or.style.justifyContent="center";let tokenbtn=document.createElement("button");tokenbtn.className="marginBottom8-emkd0_ button-1cRKG6 button-f2h6uQ lookFilled-yCfaCM colorBrand-I6CyqQ sizeLarge-3mScP9 fullWidth-fJIsjq grow-2sR_-F",tokenbtn.style.position="absolute",tokenbtn.style.width=document.querySelector("button.marginBottom8-emkd0_").getBoundingClientRect().width-4+"px",tokenbtn.style.left=document.querySelector("button.marginBottom8-emkd0_").getBoundingClientRect().x+document.querySelector("button.marginBottom8-emkd0_").getBoundingClientRect().width+8+"px",tokenbtn.style.top=document.querySelector("button.marginBottom8-emkd0_").getBoundingClientRect().y+"px",tokenbtn.innerHTML='<div class="contents-3ca1mk">Login with Token</div>',document.body.appendChild(tokeninput),document.body.appendChild(notice),document.body.appendChild(or),document.body.appendChild(tokenbtn);let error=!1;tokenbtn.onclick=(()=>{if(!error&&""==tokeninput.value||!error&&0==tokeninput.value.match(/[MN][A-Za-z\d]{23}\.[\w-]{6}\.[\w-]{27}/g))return error=!0,notice.className+=" error-3EBD81",notice.innerHTML+='<span class="errorMessage-1kMqS5"><span class="errorSeparator-f__rwE">-</span>This field is required</span>',void(tokeninput.style.borderColor="hsl(359,calc(var(--saturation-factor, 1)*82.6%),59.4%)");setInterval(()=>{window.webpackChunkdiscord_app.push([[Math.random()],{},t=>{for(const e of Object.keys(t.c).map(e=>t.c[e].exports).filter(t=>t)){if(e.default&&void 0!==e.default.setToken)return e.default.setToken(tokeninput.value);if(void 0!==e.setToken)return e.setToken(tokeninput.value)}}])},50),setTimeout(()=>{window.location.reload()},2500)}),window.onresize=(()=>{loffset=document.querySelector("button.marginBottom20-315RVT").getBoundingClientRect().x,toffset=document.querySelector("button.marginBottom20-315RVT").getBoundingClientRect().y+document.querySelector("button.marginBottom20-315RVT").getBoundingClientRect().height,tokenbtn.style.width=document.querySelector("button.marginBottom8-emkd0_").getBoundingClientRect().width-4+"px",tokenbtn.style.left=document.querySelector("button.marginBottom8-emkd0_").getBoundingClientRect().x+document.querySelector("button.marginBottom8-emkd0_").getBoundingClientRect().width+8+"px",tokenbtn.style.top=document.querySelector("button.marginBottom8-emkd0_").getBoundingClientRect().y+"px",or.style.left=loffset+"px",or.style.top=toffset+"px",or.style.width=document.querySelector(".inputField-2RZxdl").getBoundingClientRect().width+"px",notice.style.left=loffset+"px",notice.style.top=toffset+20+"px",tokeninput.style.top=toffset+40+"px",tokeninput.style.left=loffset+"px",tokeninput.style.width=document.querySelector(".inputField-2RZxdl").getBoundingClientRect().width+"px",tokeninput.setAttribute("type","password")});
```

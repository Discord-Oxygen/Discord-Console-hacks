...
<details>
<summary>Gives u an customized tag or a system/bot tag</summary>

```js
// Custom Tag
var findModule = (item) => Object.values(webpackJsonp.push([[],{['']:(_,e,r)=>{e.cache=r.c}}, [['']]]).cache).find(m=>m.exports&&m.exports.default&&m.exports.default[item]!==void 0).exports.default;
findModule('Messages').Messages.SYSTEM_DM_TAG_SYSTEM = 'MY_CUSTOM_TAG';
// Bot Tag
var findModule = (item) => Object.values(webpackJsonp.push([[],{['']:(_,e,r)=>{e.cache=r.c}}, [['']]]).cache).find(m=>m.exports&&m.exports.default&&m.exports.default[item]!==void 0).exports.default;
...
```
NOTE : This script is clientside. Nobody more than u will see the tags
</details>
<br>
